...
#import <CouchbaseLite/CBLBase.h>
...
@interface CBUITableSource : NSObject <UITableViewDataSource
...
@protocol CBUITableDelegate <UITableViewDelegate>
@optional
...
- (UITableViewCell *)couchTableSource:(CBUITableSource*)source
                cellForRowAtIndexPath:(NSIndexPath *)indexPath;

/** Called after the query's results change, before the table view is reloaded. */
- (void)couchTableSource:(CBUITableSource*)source
...
- (bool)couchTableSource:(CBUITableSource*)source
